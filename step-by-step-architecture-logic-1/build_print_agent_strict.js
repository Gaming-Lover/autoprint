...
if (fs.existsSync('github_project')) {
  fs.writeFileSync(path.join('github_project', 'print-agent.js'), agentCode, 'utf8');
}
if (fs.existsSync('local_main_files')) {
  fs.writeFileSync(path.join('local_main_files', 'print-agent.js'), agentCode, 'utf8');
}
console.log('Strict payment-verified print-agent.js created');
