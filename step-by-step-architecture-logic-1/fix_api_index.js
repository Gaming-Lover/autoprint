...
if (fs.existsSync('github_project/api')) {
  fs.writeFileSync(path.join('github_project', 'api', 'index.js'), apiIndexCode, 'utf8');
}
console.log('api/index.js updated in root and github_project');
